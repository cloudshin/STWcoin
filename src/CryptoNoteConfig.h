...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1318; // addresses start with "K"
...
const uint32_t UPGRADE_HEIGHT_V2                             = 500;
const uint32_t UPGRADE_HEIGHT_V3                             = 1000;
const uint32_t UPGRADE_HEIGHT_V4                             = 1500;
...
const int      P2P_DEFAULT_PORT                              =  31457;
const int      RPC_DEFAULT_PORT                              =  31458;
...
const char     P2P_STAT_TRUSTED_PUB_KEY[]                    = "9999f9a5a434a9f1510d13336228debfee9c918ce505efe225d8c94d045fa115";

const char* const SEED_NODES[] = { 
  "95.216.154.3:31457",
  "54.39.118.250:31457",
  "139.99.189.101:31457"
};
